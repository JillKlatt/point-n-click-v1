import {
  addEffect,
  applyProps
} from "./chunk-36SUNEJV.js";
import {
  three_module_exports
} from "./chunk-EWVSTUHX.js";
import {
  require_react
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    const ref = hasInstance && (0, import_react9.useCallback)(
      (value) => {
...
// node_modules/@react-spring/types/dist/react-spring_types.legacy-esm.js
var Any = class {
};
...
function useTrail(length, propsArg, deps) {
  ...
  if (propsFn || arguments.length == 3) {
    const ref = passedRef != null ? passedRef : result[1];
...
function useInView(props, args) {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const {
      ...
      amount = "any",
      ...restArgs
    } = intersectionArguments != null ? intersectionArguments : {};
...
// node_modules/@react-spring/three/dist/react-spring_three.legacy-esm.js
